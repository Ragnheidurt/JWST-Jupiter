...
nrs1 = get_pkg_data_filename('Data\MAST_2024-03-04T12_58_18.324Z\MAST_2024-03-04T12_58_18.324Z\JWST\jw01373003001_03101_00001\jw01373003001_03101_00001_nrs1_s3d.fits')
nrs2 = get_pkg_data_filename('Data\MAST_2024-03-04T12_58_18.324Z\MAST_2024-03-04T12_58_18.324Z\JWST\jw01373003001_03101_00001\jw01373003001_03101_00001_nrs2_s3d.fits')
...
#nrs1_smooth_closesec = signal.savgol_filter(nrs1_close_secvalue, window_length=40, polyorder=3, mode="nearest")
#nrs2_smooth_closesec = signal.savgol_filter(nrs2_close_secvalue, window_length=40, polyorder=3, mode="nearst")
...
plt.figure(6)
plt.plot(nrs1_close_secwave,nrs1_close_secwave)
plt.plot(nrs2_close_secwave,nrs2_close_secwave)
#plt.plot(nrs1_close_secwave,nrs1_smooth_closesec)
#plt.plot(nrs2_close_secwave,nrs2_smooth_closesec)
